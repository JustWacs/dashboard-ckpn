...
const dataSource = [
  {
    key: "1",
    "Tanggal Unggah": "2024-06-30  19:45:01",
    "Nama File": "20240930_data_realisasi_eksekusi_agunan.xlsx",
    "Jumlah Record": "3",
    Status: "Berhasil",
    "Pesan Kesalahan": "",
  },
  {
    key: "2",
    "Tanggal Unggah": "2024-06-300  19:05:23",
    "Nama File": "20240930_data_realisasi_eksekusi_agunan.xlsx",
    "Jumlah Record": "3",
  ...
  },
  {
    ...
    render: (_, record) => (
      <div className="flex gap-2">
        <Link href={`/perhitungan-ckpn/unggah-data-pinjaman/data-realisasi-eksekusi-agunan/view?title=${encodeURIComponent(record["Nama File"])}&tanggal=${encodeURIComponent(record["Tanggal Unggah"])}`}>
    ...
    <>
      <div className="flex flex-col w-full bg-white-accent">
        ...
        <div className="m-5 h-screen bg-white">
          <HeaderContent title="Unggah Data Pinjaman | Data Realisasi Eksekusi Agunan" />
