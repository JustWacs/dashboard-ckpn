...
const dataSource = [
  {
    ...
    "CKPN Kolektif": "PD: Klasifikasi Pinjaman:  2 - Jenis Produk Metode Perhitungan PD:  2 - Migration Rentang Waktu PD (Bulan): 12 Interval Rata-Rata PD:  2 - Triwulanan 103 Rekening Pinjama 2 Rekening Hapus Buku 1  Realisasi Eksekusi Agunan LGD Metode Perhitungan LGD: 2 - Collateral Shortfall Rentang Waktu LGD (Tahun): 5",
  ...
  return (
    <>
      <div className="flex flex-col w-full bg-white-accent">
        <HeaderPage title="Persetujuan Hasil CKPN" />
        <div className="m-5 h-screen bg-white">
          <HeaderContent title="Persetujuan Hasil CKPN" />
