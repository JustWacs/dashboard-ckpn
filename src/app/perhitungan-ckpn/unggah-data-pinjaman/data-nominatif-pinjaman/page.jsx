...
const dataSource = [
  {
    key: "1",
    "Tanggal Unggah": "2024/06/30  19:35:01",
    "Nama File": "20240930_data_nominatif_pinjaman.xlsx",
    "Jumlah Record": "3",
    Status: "Berhasil",
    "Pesan Kesalahan": "",
  },
  ...
  },
  {
    ...
    render: (_, record) => (
      <div className="flex gap-2">
        <Link href={`/perhitungan-ckpn/unggah-data-pinjaman/data-nominatif-pinjaman/view?title=${encodeURIComponent(record["Nama File"])}&tanggal=${encodeURIComponent(record["Tanggal Unggah"])}`}>
