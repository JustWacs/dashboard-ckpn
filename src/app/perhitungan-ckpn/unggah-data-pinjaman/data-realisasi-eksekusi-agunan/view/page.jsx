...
const dataSource = [
  {
    ...
    "Tanggal Eksekusi Agunan": "2024-03-10",
    "Nilai Agunan": "Rp 75.000.000,00",
    "Realisasi Penjualan Agunan": "Rp 55.000.000,00",
  },
];
...
const columns = [
  ...
  {
    title: "Tanggal Eksekusi Agunan",
    dataIndex: "Tanggal Eksekusi Agunan",
    key: "Tanggal Eksekusi Agunan",
    width: 100, // Reduced width
  },
  {
    title: "Nilai Agunan",
    dataIndex: "Nilai Agunan",
    key: "Nilai Agunan",
    width: 100, // Reduced width
  },
  {
    title: "Realisasi Penjualan Agunan",
    dataIndex: "Realisasi Penjualan Agunan",
    key: "Realisasi Penjualan Agunan",
    width: 120, // Reduced width
  },
  {
    title: "Aksi",
